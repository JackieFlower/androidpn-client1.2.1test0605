...
public class ConnectionConfiguration implements Cloneable {
     ...
     * 
     * 为特定的服务名称创建新的ConnectionConfiguration。
     * 一个DNS SRV查询
     *
    ...
    public ConnectionConfiguration( String resourceID, String host,int port) {
        init(host, port, host, ProxyInfo.forDefaultProxy());
    }
