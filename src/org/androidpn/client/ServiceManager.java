...
public final class ServiceManager {
    ...
    //由demoAPPAcitivity启动（即context的值为demoAPPAcitivity）
    public ServiceManager(Context context) {
        ...
        resourceID = props.getProperty("resourceID", "0000000");
        
        Log.i(LOGTAG, "apiKey=" + apiKey);
        Log.i(LOGTAG, "xmppHost=" + xmppHost);
        Log.i(LOGTAG, "xmppPort=" + xmppPort);
        Log.i(LOGTAG, "resourceID=" + resourceID);
        ...
        //editor.putString(Constants.XMPP_RESOURCEID, resourceID);
