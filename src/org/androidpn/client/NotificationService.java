 ...
 * 
 * 这个是一直在后台运行的服务，它负责响应从服务器端推送通知事件
 * 它必需在AndroidManifest.xml中注册
...
public class NotificationService extends Service {
    ...
    private void registerNotificationReceiver() {
        ...
        filter.addAction(Constants.ACTION_NOTIFICATION_INSTALLED);

        //注册NotificationReceiver,进行Notification的相应处理
